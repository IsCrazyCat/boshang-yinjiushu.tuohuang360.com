<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:42:"./application/admin/view2/index\index.html";i:1570852386;s:45:"./application/admin/view2/public\menubox.html";i:1524303756;s:42:"./application/admin/view2/public\left.html";i:1541405221;}*/ ?>
<!doctype html>
<html>
<head>
...
$(function(){
	...
	function ajaxFileUpload()
	{
		...
		(
			{
				url:'http://www.boshang3710.com/admin/index.php?act=common&op=pic_upload&type=admin_avatar&form_submit=ok&uploadpath=admin/avatar',
				secureuri:false,
				fileElementId:'_pic',
				dataType: 'json',
				...
				{
					if (data.status == 1){
						ajax_form('cutpic','裁剪','http://www.boshang3710.com/admin/index.php?act=common&op=pic_cut&type=admin_avatar&x=100&y=100&resize=1&ratio=1&url='+data.url,690);
					}else{
						alert(data.msg);
					}
...
function call_back(picname){
    $.getJSON('index.php?act=index&op=save_avatar&avatar=' + picname, function(data){
        if (data) {
            $('img[tptype="admin_avatar"]').attr('src', 'http://www.boshang3710.com/data/upload/admin/avatar/' + picname);
        }
    });
}
</script> 
...
<div class="admincp-header">
  ...
  <div class="admincp-name" onClick="javascript:openItem('welcome|Index');">
    <!-- <h2 style="cursor:pointer;">平台系统管理中心</h2> -->
    <img src="__PUBLIC__/static/images/TPlogo.png" alt="">
  </div>
  <div class="nc-module-menu">
    <ul class="nc-row">
      <!--<li data-param="mobile" onClick="javascript:openItem('welcome|Index');" ><a href="javascript:void(0);" >操作</a></li>-->
  ...
  <div class="admincp-header-r">
    ...
    <ul class="operate nc-row">
      <li style="display: none !important;" tptype="pending_matters"><a class="toast show-option" href="javascript:void(0);" onClick="$.cookie('commonPendingMatters', 0, {expires : -1});ajax_form('pending_matters', '待处理事项', 'http://www.boshang3710.com/admin/index.php?act=common&op=pending_matters', '480');" title="查看待处理事项">&nbsp;<em>0</em></a></li>
