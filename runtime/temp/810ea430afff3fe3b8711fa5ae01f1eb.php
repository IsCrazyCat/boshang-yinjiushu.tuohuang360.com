<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:47:"./application/admin/view2/goods\stock_list.html";i:1524293402;s:44:"./application/admin/view2/public\layout.html";i:1524293403;}*/ ?>
<!doctype html>
<html>
<head>
                ...
                <table>
                    ...
                    <?php if(is_array($stock_list) || $stock_list instanceof \think\Collection || $stock_list instanceof \think\Paginator): $i = 0; $__LIST__ = $stock_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($i % 2 );++$i;?>
                        <tr>
                            ...
                            <td align="center" class="">
                                <div style="text-align: center; width: 300px;"><?php echo getSubstr($v['goods_name'],0,30); ?></div>
                            </td>
                            <td align="center" class="">
                                <div style="text-align: center; width: 100px;"><?php echo $v['goods_spec']; ?></div>
                            </td>
                            <td align="center" class="">
