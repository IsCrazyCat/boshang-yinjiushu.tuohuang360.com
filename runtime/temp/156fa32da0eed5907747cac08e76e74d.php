<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:44:"./template/mobile/new2/user\withdrawals.html";i:1574217901;s:41:"./template/mobile/new2/public\header.html";i:1542371282;s:45:"./template/mobile/new2/public\header_nav.html";i:1533297512;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
    ...
    <div class="footer">
		...
		<div class="loginsingup-input ma-to-20">
			<form action="?" method="post" onsubmit="return checkSubmit()">
               <div class="content30">
                 <div class="lsu">
                 <p>1.当日14:00前提现，当日支付；14:00后提现，次日支付；节假日及周末顺延到工作日!</p>
                 <p>2.提现会扣 6<strong>‰ </strong>的手续费!</p></div></div>
				<div class="content30">
					<div class="lsu">
						<span>卡号：</span>
                    ...
                    <div class="lsu">
                        <span>提现金额：</span>
                        <input type="text" name="money" id="money" value="" usermoney="<?php echo $user_money; ?>" placeholder="请填写提现金额" onKeyUp="this.value=this.value.replace(/[^\d.]/g,'')">
                    </div>
                   <!-- <div class="lsu test">
                        <span>验证码：</span>
