<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:45:"./application/admin/view2/distribut\tree.html";i:1570438198;s:44:"./application/admin/view2/public\layout.html";i:1524293403;}*/ ?>
<!doctype html>
<html>
<head>
...
if ( $v['user_id'] > 0 ) { 
    ...
    while($row = mysql_fetch_array($result)) {
    	$count_1 = $row['count1'];
        echo " 推荐人数 [".$row['count1']."]";
    }
} 
                                       ?>
                                      消费总额 [<?php echo $v['total_amount']; ?>] 当前等级 
                                      [<?php if($v['level'] == '1'): ?>注册会员<?php endif; if($v['level'] == '2'): ?>公司会员<?php endif; if($v['level'] == '3'): ?>公司经销商<?php endif; if($v['level'] == '4'): ?>高级公司经销商<?php endif; ?>]
	                              </span>
