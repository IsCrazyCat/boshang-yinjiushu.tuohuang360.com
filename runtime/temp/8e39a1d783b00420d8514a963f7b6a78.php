<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:47:"./template/mobile/new2/cart\ajax_cart_list.html";i:1572694069;}*/ ?>
            ...
            <div class="sc_list">
                ...
                <div class="deleshow fr">
                    ...
                    <div class="prices">
                        ...
                        <!--加减数量-->
                        <?php if($mylevel == 1): ?>
                        	<div class="plus fr get_mp" style="width:4.5rem; font-size:0.7rem;" >
                            <input name="oprest" type="radio"   onclick="my_switch_num(10,<?php echo $v['id']; ?>,<?php echo $v['store_count']; ?>)" value="10" <?php if($v['goods_num'] == 10): ?>checked="checked"<?php endif; ?> />10 提<br />

                            <input <?php if($v['goods_num'] == 30): ?>checked="checked"<?php endif; ?> name="oprest" type="radio" value="30" onclick="my_switch_num(30,<?php echo $v['id']; ?>,<?php echo $v['store_count']; ?>)" />30 提
                            <input id="goods_num[<?php echo $v['id']; ?>]" type="text" style=" height:1rem; background-color:#fff; display:none  " onkeydown='if(event.keyCode == 13) event.returnValue = false' name="goods_num[<?php echo $v['id']; ?>]"  value="<?php echo $v['goods_num']; ?>"  class="input-num"  onblur="switch_num(0,<?php echo $v['id']; ?>,<?php echo $v['store_count']; ?>)"/>
                          </div>
                          <script language="javascript">my_switch_num(10,<?php echo $v['id']; ?>,<?php echo $v['store_count']; ?>);</script>
                        <?php else: ?>
                            <div class="plus fr get_mp" style="width:4.5rem;" >
                                <span style="width: 1.1rem; font-size: 1rem;" class="mp_minous" onclick="switch_num(-1,<?php echo $v['id']; ?>,<?php echo $v['store_count']; ?>)">-</span><span style="width: 2.3rem; font-size: 0.8rem;" class="mp_mp"><span class="plus fr get_mp" style="width:4.5rem;"><span class="mp_mp" style="width: 2.3rem; font-size: 0.8rem;">
                                <input id="goods_num[<?php echo $v['id']; ?>]" type="text" style="font-size:0.7rem; height:1rem; background-color:#fff;  " onkeydown='if(event.keyCode == 13) event.returnValue = false' name="goods_num[<?php echo $v['id']; ?>]"  value="<?php echo $v['goods_num']; ?>"  class="input-num"  onblur="switch_num(0,<?php echo $v['id']; ?>,<?php echo $v['store_count']; ?>)"/>
                                </span></span></span><span style="width: 1.1rem;font-size: 1rem;"  class="mp_plus" onclick="switch_num(5, <?php echo $v['id']; ?>, <?php echo $v['store_count']; ?>)">+</span>
                                <p style="width:100%; text-align:center; padding-top:0.5rem; padding-bottom:0.5rem; margin-top:0.5rem; margin-bottom:0.5rem;"><br />
    点击改写</p>
                            </div>
                        <?php endif; ?>
