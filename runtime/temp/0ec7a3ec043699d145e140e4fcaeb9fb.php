<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:43:"./template/mobile/new2/goods\goodsInfo.html";i:1570923490;s:41:"./template/mobile/new2/public\header.html";i:1542371282;s:42:"./template/mobile/new2/public\top_nav.html";i:1533297481;s:43:"./template/mobile/new2/public\wx_share.html";i:1571744578;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
...
<div class="xq_details">
    ...
    <div class="de_font p">
        <div class="thirty">
            ...
            <div class="scunde p">
                   ...
                   <!--<p>市场价：<span class="linethr"><?php echo $goods['market_price']; ?></span></p>-->
                   <p class="red" id="shop_price">￥<?php echo $shop_price; ?></p>
    ...
    <div class="floor list7 detailsfloo" style="display:none">
        <div class="myorder p">
            <div class="content30">
        ...
        <div class="myhearders myorder" style="display:none">
        ...
        <div class="myorder p seedeadei">
            <div class="content30">
                <a href="javascript:void(0)">
                    <div class="order">
                        <div class="fl">
                            <span class="firde red">商品详情</span>
                        </div>
                        <div class="fr">
                            <i class="Mright"></i>
                        </div>
...
<div class="xq_details">      
   <div class="sg">
    ...
    <div class="recommed p"  style="display:none">
        <h2>为您推荐</h2>
...
<!--底部按钮-s-->
    ...
    <div class="cart-concert-btm p">
        <div class="fl">
            <ul>
                <li>
                    <!--<a href="tencent://message/?uin=<?php echo $tpshop_config['shop_info_qq']; ?>&Site=饮久舒新时代商城&Menu=yes">-->
        ...
        <div class="fr">
            <ul>
                <li class="o">
                    <a class="pb_plusshopcar button active_button " href="javascript:void(0);" onClick="AjaxAddCart(<?php echo $goods['goods_id']; ?>,10,0);"> 加入购物车</a>
                </li>
                <li class="r">
                    <a style="display:block;" href="javascript:void(0);"  onclick="AjaxAddCart(<?php echo $goods['goods_id']; ?>,10,1);">立即购买</a>
                </li>
            </ul>
        </div>
    </div>
...
<form name="buy_goods_form" method="post" id="buy_goods_form" >
    <div class="choose_shop_aready p">
            ...
            <div class="maleri30">
                <div class="shopprice">
                    ...
                    <div class="fon_or fl">
                        ...
                        <div class="price_or" id="goods_price"><span>￥</span><span><?php echo $shop_price; ?></span></div>
                ...
                <div class="shulges p">
                    ...
                    <div class="plus">
                        <span class="mp_minous" onclick="altergoodsnum(-1)">-</span>
                                <span class="mp_mp">
                        <input type="text" class="num" id="number" residuenum="<?php echo $goods['store_count']; ?>" name="goods_num" value="10" max="" onblur="altergoodsnum(0)">
                                </span>
        ...
        <div class="plusshopcar-buy p">
            <a class="pb_plusshopcar button active_button " href="javascript:void(0);" onClick="AjaxAddCart(<?php echo $goods['goods_id']; ?>,10,0);">加入购物车</a>
            <a class="pb_buy" href="javascript:void(0);"  onclick="AjaxAddCart(<?php echo $goods['goods_id']; ?>,10,1);">立即购买 </a>
        </div>
    </div>
</form>
<!--选择属性的弹窗-e-->
...
//完
    ...
    {
        var goods_price = <?php echo $shop_price; ?>; // 商品起始价
        ...
        $("#shop_price").html('￥'+goods_price+'元'); // 变动价格显示
