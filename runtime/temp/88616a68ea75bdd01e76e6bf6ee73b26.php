<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./application/admin/view2/order\detail.html";i:1572052528;s:44:"./application/admin/view2/public\layout.html";i:1524293403;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <div class="ncap-order-details">
      ...
      <form id="order-action">
        <div class="tabs-panels">
         <div class="misc-info">
             <h3>购买人：<?php echo $order['username']; ?>&nbsp;<?php echo $order['nickname']; ?>&nbsp;（ID:<?php echo $order['user_id']; ?>）&nbsp;&nbsp;&nbsp;推荐人：<?php echo $order['tjr_username']; ?>&nbsp;<?php echo $order['tjr_nickname']; ?> &nbsp;（ID:<?php echo $order['tjr_user_id']; ?>）</h3>
         </div>       
          ...
          <table>
            ...
            <?php if(is_array($orderGoods) || $orderGoods instanceof \think\Collection || $orderGoods instanceof \think\Paginator): $i = 0; $__LIST__ = $orderGoods;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$good): $mod = ($i % 2 );++$i;?>
           	<tr>
                ...
                <td class="w30"><div class="goods-thumb"><a href="<?php echo U('Mobile/Goods/goodsInfo',array('id'=>$good['goods_id'])); ?>" target="_blank"><img alt="" src="<?php echo goods_thum_images($good['goods_id'],200,200); ?>" /> </a></div></td>
                <td style="text-align: left;"><a href="<?php echo U('Mobile/Goods/goodsInfo',array('id'=>$good['goods_id'])); ?>" target="_blank"><?php echo $good['goods_name']; ?></a><br/></td>
	      ...
	      <dl class="row">
	        ...
	        <dd class="opt" style="margin-left:10px">
	         	<?php if(is_array($button) || $button instanceof \think\Collection || $button instanceof \think\Paginator): if( count($button)==0 ) : echo "" ;else: foreach($button as $k=>$vo): if($k == 'pay_cancel'): ?>
               		...
               		<?php elseif($k == 'refund'): else: if($k != 'invalid'): ?><a class="ncap-btn-big ncap-btn-green" onclick="ajax_submit_form('order-action','<?php echo U('Admin/order/order_action',array('order_id'=>$order['order_id'],'type'=>$k)); ?>');" ><?php echo $vo; ?></a><?php endif; endif; endforeach; endif; else: echo "" ;endif; ?>
	        </dd>
	      </dl> 
        </div>
        <div class="goods-info">
