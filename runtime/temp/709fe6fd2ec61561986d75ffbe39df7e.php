<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:48:"./application/admin/view2/comment\ajaxindex.html";i:1542284218;}*/ ?>
<table>
 	<tbody>
  	...
  	<tr data-id="<?php echo $list['comment_id']; ?>">
        ...
        <td align="center" abbr="article_show" axis="col5" class="" style="white-space: normal;">
            <div style="text-align: left; width: 200px;white-space: normal;height:inherit;line-height: inherit;" class="">
          		<a target="_blank" href="<?php echo U('Mobile/Goods/goodsInfo',array('id'=>$list[goods_id])); ?>"><?php echo $goods_list[$list[goods_id]]; ?></a>
          	</div>
        </td>
