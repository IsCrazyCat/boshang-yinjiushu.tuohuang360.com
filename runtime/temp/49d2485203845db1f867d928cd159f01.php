<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:43:"./template/mobile/new2/user\order_list.html";i:1571792839;s:41:"./template/mobile/new2/public\header.html";i:1542371282;s:45:"./template/mobile/new2/public\header_nav.html";i:1533297512;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
...
<div class="tit-flash-sale p mytit_flash">
    <div class="maleri30">
        <ul class="">
            <li style="width:25%" <?php if(\think\Request::instance()->param('type') == ''): ?>class="red"<?php endif; ?>>
                <a href="<?php echo U('/Mobile/User/order_list'); ?>" class="tab_head">全部订单</a>
            </li>
            <!--<li style="width:25%" id="WAITPAY" <?php if(\think\Request::instance()->param('type') == 'WAITPAY'): ?>class="red"<?php endif; ?>">
                <a href="<?php echo U('/Mobile/User/order_list',array('type'=>'WAITPAY')); ?>" class="tab_head" >待付款</a>
            </li>-->
            <li style="width:25%" id="WAITSEND" <?php if(\think\Request::instance()->param('type') == 'WAITSEND'): ?>class="red"<?php endif; ?>>
                <a href="<?php echo U('/Mobile/User/order_list',array('type'=>'WAITSEND')); ?>"  class="tab_head">待发货</a>
            </li>
            <li  style="width:25%" id="WAITRECEIVE"><a href="<?php echo U('/Mobile/User/order_list',array('type'=>'WAITRECEIVE')); ?>"  class="tab_head <?php if(\think\Request::instance()->param('type') == 'WAITRECEIVE'): ?>on<?php endif; ?>">待收货</a></li>
            <li style="width:25%" id="WAITCCOMMENT"  <?php if(\think\Request::instance()->param('type') == 'WAITCCOMMENT'): ?>class="red"<?php endif; ?>>
