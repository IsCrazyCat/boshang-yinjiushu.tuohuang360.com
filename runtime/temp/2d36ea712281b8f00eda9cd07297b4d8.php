<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:38:"./template/mobile/new2/user\index.html";i:1571792949;s:41:"./template/mobile/new2/public\header.html";i:1542371282;s:45:"./template/mobile/new2/public\footer_nav.html";i:1542180611;s:43:"./template/mobile/new2/public\wx_share.html";i:1571744578;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
    <title>会员中心--<?php echo $tpshop_config['shop_info_store_title']; ?></title>
    ...
    <div class="myhearder">
        <div class="person">
            <!--<a href="">-->
                ...
                <div class="fl lors" style="text-align: center;height:2.688rem;padding:0.8rem 0.3rem;margin:0;">
                  <div style="padding:0.1rem 0;">
                    <span style="float:left"><?php echo $user['nickname']; ?></span>
                    <span style="float:left; font-size:0.6rem;padding:0.1rem 0;"  >〖<?php if($user[level] == 2): ?>公司会员<?php elseif($user[level] == 3): ?>公司经销商<?php elseif($user[level] == 4): ?>合伙创始人<?php else: ?>注册会员<?php endif; ?>〗</span>
                    <?php if($first_nickname != ''): ?>
                        <span style="float:left; font-size:0.6rem;padding:0.1rem 0;">由(<?php echo $first_nickname; ?>)推荐</span>
                    <?php endif; ?>
                   ...
                   <!-- <li>
                    ...
                    <li>
                        <a href="<?php echo U('Mobile/distribut/rebate_log_20181211'); ?>">
                            <h2><?php echo (isset($prepare_money) && ($prepare_money !== '')?$prepare_money:"0.00"); ?></h2>
                            <p>冻结佣金</p>
                        </a>
                    </li>  
