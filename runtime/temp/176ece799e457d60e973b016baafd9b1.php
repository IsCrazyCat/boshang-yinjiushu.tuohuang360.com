<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:42:"./application/admin/view2/admin\login.html";i:1529139136;}*/ ?>
<!doctype html>
        ...
        <form action="" name='theForm' id="theForm" method="post">
            <div class="login-form" style="position: relative">
                <div class="formContent">
                	<div class="title" style="color:#FF0000">管理中心</div>
                    <div class="formInfo">
                    	<div class="formText">
                        ...
                        <div class="formText">
                           ...
                           <span class="span" style="color:#00ff00">保存信息</span>
                            <a href="<?php echo U('Admin/forget_pwd'); ?>" class="forget_pwd" style="color:#00ff00">忘记密码？</a>
                        </div>
						<div class="formText submitDiv">
                          <span class="submit_span">
                          	<input type="button" name="submit" class="sub" style="color:#FF0000; border:#FF0000 1px solid;" value="登录">
                          </span>
                       </div>
                    </div>
                </div>
