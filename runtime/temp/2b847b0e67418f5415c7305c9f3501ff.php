<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:41:"./application/admin/view2/user\index.html";i:1572054683;s:44:"./application/admin/view2/public\layout.html";i:1524293403;}*/ ?>
...
</head><body style="background-color: rgb(255, 255, 255); overflow: auto; cursor: default; -moz-user-select: inherit;">
...
<div class="page">
    ...
    <div id="explanation" class="explanation" style="color: rgb(44, 188, 163); background-color: rgb(237, 251, 248); width: 99%; height: 100%;">
        ...
        <ul>
            <li>平台累计消费：<?php echo (isset($ptljxf) && ($ptljxf !== '')?$ptljxf:"0.00"); ?> 平台累积分佣金额：<?php echo (isset($ptljfyje) && ($ptljfyje !== '')?$ptljfyje:"0.00"); ?> 平台累积冻结佣金：<?php echo (isset($ptdjyj) && ($ptdjyj !== '')?$ptdjyj:"0.00"); ?> 平台累积可用余额：<?php echo (isset($ptljkyye) && ($ptljkyye !== '')?$ptljkyye:"0.00"); ?></li>
        </ul>
    </div>
    <div class="flexigrid">
        <div class="mDiv">
            ...
            <form class="navbar-form form-inline"  id="search-form2" onSubmit="return false">
                ...
                <div class="sDiv">
                    <div class="sDiv2">
                        <input type="text" id="search_key" size="30" class="qsbox" placeholder="昵称...">
                ...
                <table cellspacing="0" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <th align="center" abbr="level" axis="col5" class="">
                            <div style="text-align: center; width: 280px;" class="">会员等级</div>
                        </th>
                        ...
                        <th align="center" abbr="pay_points" axis="col6" class="">
                            <div style="text-align: center; width: 100px;" class="">累积分佣金额</div>
                        </th>
                        <th align="center" abbr="pay_points" axis="col6" class="">
                            <div style="text-align: center; width: 100px;" class="">冻结佣金</div>
                        </th>
