<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:43:"./application/admin/view2/goods\_goods.html";i:1570332239;s:44:"./application/admin/view2/public\layout.html";i:1524293403;}*/ ?>
<!doctype html>
<html>
<head>
...
<!--通用信息-->
        <div class="ncap-form-default tab_div_1">
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="record_no">会员价<span style="color:#F00">*</span></label>
                </dt>
                <dd class="opt">
                    <input type="text" value="<?php echo $goodsInfo['shop_price']; ?>" name="shop_price" id="shop_price" class="t_mane" onKeyUp="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" onFocus="ggjg(this.value);" />
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" value="<?php echo $goodsInfo['market_price']; ?>" name="market_price" id="market_price" class="t_mane" onKeyUp="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input type="text" value="<?php echo $goodsInfo['cost_price']; ?>" name="cost_price" id="cost_price" class="t_mane" onKeyUp="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />
            ...
            <dl class="row" style="display:none" >
                ...
                <dd class="opt">
                    <input type="text" value="<?php echo $goodsInfo['commission']; ?>" name="commission" id="commission" class="t_mane" onKeyUp="this.value=this.value.replace(/[^\d.]/g,'')" onpaste="this.value=this.value.replace(/[^\d.]/g,'')" />
...
function fmoney(s, n) {
    ...
    return t.split("").reverse().join("") + "." + r;
				...
				function ggjg(thisvalue){
					document.getElementById('market_price').value = fmoney(thisvalue*1.2);
					document.getElementById('cost_price').value = fmoney(thisvalue/1.2);
					//document.getElementById('commission').value = fmoney(thisvalue*0.05);
				}
            </script>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    ...
                    <p class="notic"> 务必设置商品重量, 用于计算物流费.</p>
                </dd>
            </dl>  
	  <dl class="row">
        <dt class="tit">
