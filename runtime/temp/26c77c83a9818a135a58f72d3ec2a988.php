<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:44:"./template/mobile/new2/user\add_address.html";i:1542700916;s:41:"./template/mobile/new2/public\header.html";i:1542371282;s:45:"./template/mobile/new2/public\header_nav.html";i:1533297512;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="UTF-8" />
                    ...
                    <div class="content30">
                        <a href="javascript:void(0)">
                            <div class="order">
                                ...
                                <div class="fl">
       <input type="tel" value="<?php echo $address['mobile']; ?>" name="mobile" onkeyup="this.value=this.value.replace(/[^\d]/g,'')"/>
                                </div>
                            </div>
                        </a>
                    </div>
        ...
        <div class="edita" style="margin-bottom:4.1rem; padding-bottom:4.1rem; bottom:4.1rem;" >
            <div class="content30">
