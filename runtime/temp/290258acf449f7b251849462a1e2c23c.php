<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:44:"./application/admin/view2/index\welcome.html";i:1571039958;}*/ ?>
<html>
<head>
                    ...
                    <div class="sc_warp" style="padding-bottom: 30px;">
                        <table cellpadding="0" cellspacing="0" class="system_table">
                            <tbody><tr>
                                ...
                                <td>BOSHANGSHOP <?php echo $sys_info['version']; ?></td>
                            ...
                            <tr>
                                ...
                                <td><a href="http://www.boshang3710.com/" target="_blank">商业授权</a></td>
                                <td class="gray_bg">官方论坛:</td>
                                <td><a href="http://www.boshang3710.com/articleList_cat_id_31.html" target="_blank">BOSHANGSHOP交流论坛</a></td>
                            </tr>
                            </tbody></table>
                    </div>
                </div>-->
...
<div id="footer" style="position: static; bottom: 0px; font-size:14px;">
    <p><b>版权所有 © 2012-2018 山东博商网络科技有限公司，并保留所有权利。</b></p>
</div>
