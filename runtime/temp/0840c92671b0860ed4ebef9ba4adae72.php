<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:57:"./application/admin/view2/distribut\distributor_list.html";i:1570867546;s:44:"./application/admin/view2/public\layout.html";i:1524293403;}*/ ?>
<!doctype html>
<html>
<head>
        ...
        <table cellspacing="0" cellpadding="0">
          <thead>
	        	<tr>
	              ...
	              <th align="center" abbr="article_time" axis="col6" class="">
	                <div style="text-align: center; width: 80px;" class="">代理会员总数</div>
	              </th>
	              <th align="center" abbr="article_time" axis="col6" class="">
