<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:42:"./template/mobile/new2/user\visit_log.html";i:1524293412;}*/ ?>
<!DOCTYPE html>
<html>
	<head>
		<meta charset="utf-8" />
		...
		<div class="classreturn loginsignup">
			<div class="content">
				<div class="ds-in-bl return">
					<a href="<?php echo U('User/'); ?>"><img src="__STATIC__/images/return.png" alt="返回"></a>
				</div>
