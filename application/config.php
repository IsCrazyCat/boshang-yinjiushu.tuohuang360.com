...
//        '6'=>array('身份验证','尊敬的 ${user_name}用户，您的验证码为${code}, 本验证码有效时间为10分钟, 请勿告诉他人.','bind_mobile_sms_enable'),
        ...
        '1'=>array('用户注册','验证码${code}，有郊期五分钟。','regis_sms_enable'),
        '2'=>array('用户找回密码','验证码${code}，有郊期五分钟。','forget_pwd_sms_enable'),
        '3'=>array('客户下单','您有新订单，收货人：${consignee}，联系方式：${phone}，请您及时查收.','order_add_sms_enable'),
        '4'=>array('客户支付','订单:${order_sn}已经支付，请及时发货.','order_pay_sms_enable'),
        '5'=>array('商家发货','尊敬的${user_name}用户，您的订单${order_sn}已发货，收货人${consignee}，请您及时查收','order_shipping_sms_enable'),
        '6'=>array('身份验证','验证码${code}，有郊期五分钟。','bind_mobile_sms_enable'),
        '10'=>array('消费返佣金','您的推荐的${user_name}已经在${sms_sign}消费，您获得佣金${duoshaoyongjin}元。','jffy_mobile_sms_enable'),
        '11'=>array('会员生日祝福','尊敬的 ${user_name}用户，今天是您的生日, 祝你生日快乐。','srzf_mobile_sms_enable'),
        '12'=>array('股东消费','尊敬的红岩股东 ${user_name} 您好，您在店成功消费 ${duoshaoyuan} 元，余额为 ${yue} 元，恭候您的再次光临。','gdxf_mobile_sms_enable'),
    ...
    /**假设这个访问地址是 www.boshang3710.com/home/goods/goodsInfo/id/1.html 
