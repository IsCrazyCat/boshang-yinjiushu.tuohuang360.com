...
class Payment extends MobileBase {
	...
	//			}*/
           ...
           if($this->pay_code == 'weixin' && $_SESSION['openid'] && strstr($_SERVER['HTTP_USER_AGENT'],'MicroMessenger')){
			    //支付前本地生成商户订单号 lishibo
               M('order')->where("order_id", $order_id)->save(array('out_trade_no'=>$order['order_sn'].time()));
               $code_str = $this->payment->getJSAPI($order);
//               echo "<pre>";'1'.print_r($code_str);echo "<pre>";
               exit($code_str);
    ...
    public function getPay(){
        ...
        // 服务器点对点 // http://www.boshang3710.com/index.php/Home/Payment/notifyUrl        
        public function notifyUrl(){            
            $this->payment->response();            
            exit();
        }

        // 页面跳转 // http://www.boshang3710.com/index.php/Home/Payment/returnUrl        
